  ...
  Widget _buildCategoryCard(ExpenseCategory category) {
    ...
    return Container(
      margin: const EdgeInsets.only(bottom: 6), // Reducido de 12
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(12), // Reducido de 16
        boxShadow: [
          BoxShadow(
            color: Colors.grey.withOpacity(0.08), // Sombra más sutil
            blurRadius: 4,
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8), // Reducido de all(16)
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(8), // Reducido de 12
                  ),
                  child: Icon(
                    category.isActive ? Icons.local_offer : Icons.local_offer_outlined,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (category.description != null && category.description!.isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.only(top: 2), // Reducido de 4
                          child: Text(
                ...
                Row(
                  children: [
                    IconButton(
                        icon: const Icon(Icons.edit_outlined, size: 18, color: Colors.blueGrey), // Reducido de 20
                        tooltip: 'Editar',
                    ...
                    IconButton(
                        icon: const Icon(Icons.delete_outline, size: 18, color: Colors.redAccent), // Reducido de 20
                        tooltip: 'Eliminar',
                        padding: EdgeInsets.zero,
                        constraints: const BoxConstraints(),
  ...
  Color _getColorForCategory(String name) {
    final colors = [
      ...
      Colors.amber, Colors.cyan, Colors.deepOrange, Colors.lightBlue
    ];
