...
class _EditExpenseScreenState extends State<EditExpenseScreen> {
  ...
  // Aquí se inicializan con los datos del gasto
  // ============================================
  ...
  void initState() {
    ...
    _dateController = TextEditingController(text: widget.expense.formattedDate);
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          // Si la categoría actual no existe en la lista, seleccionar la primera
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _isLoading ? null : _handleUpdateExpense,
                    ...
                    child: OutlinedButton(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                          color: _isLoading ? Colors.grey[300] : Colors.indigo[600],
                        ),
                      ),
                    ),
                  ),
